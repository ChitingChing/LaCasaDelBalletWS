...
import com.lacasadelballetws.entities.Pagoventa;
 ...
 */
@Stateless
@Path("com.lacasadelballetws.entities.pagoventa")
public class PagoventaFacadeREST extends AbstractFacade<Pagoventa> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Pagoventa entity) {
        super.edit(entity);
    }
    ...
    public Pagoventa find(@PathParam("id") Integer id) {
